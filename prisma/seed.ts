...
async function main() {
  ...
  const sandro = await prisma.driver.create({
    data: {
  ...
  const mariana = await prisma.driver.create({
    data: {
      name: "Mariana Lima",
      phone: "(11) 98888-5555",
      active: true,
  ...
  const postoGraal = await prisma.gasStation.create({
    data: {
      name: "Posto Shell Graal",
      cnpj: "12.345.678/0001-90",
      active: true,
      address: "Rodovia Dutra, Km 200",
    },
  })
  ...
  const dieselS10Graal = await prisma.contractFuel.create({
    data: {
      contractId: contratoGraal.id,
      fuelType: "DIESEL_S10",
      pricePerLiter: 6.20,
      litersContracted: 30000,
      litersAvailable: 22000,
      litersConsumed: 8000,
    },
  })
  ...
  const dieselComumGraal = await prisma.contractFuel.create({
    data: {
      ...
      fuelType: "DIESEL_COMUM",
      pricePerLiter: 5.95,
      litersContracted: 20000,
      litersAvailable: 15000,
      litersConsumed: 5000,
    },
  })
  ...
  const gasolinaComumIpiranga = await prisma.contractFuel.create({
    data: {
      contractId: contratoIpiranga.id,
      fuelType: "GASOLINA_COMUM",
      pricePerLiter: 5.80,
      litersContracted: 10000,
      litersAvailable: 8500,
      litersConsumed: 1500,
    },
  })
  ...
  const etanolIpiranga = await prisma.contractFuel.create({
    data: {
      ...
      fuelType: "ETANOL",
      pricePerLiter: 3.90,
      litersContracted: 15000,
      litersAvailable: 12000,
      litersConsumed: 3000,
    },
  })
  ...
  const req1 = await prisma.fuelingRequest.create({
    data: {
      vehicleId: volvo.id,
      driverId: carlos.id,
      contractFuelId: dieselS10Graal.id,
  ...
  await prisma.fueling.create({
    data: {
      ...
      pricePerLiter: 6.20,
      totalAmount: 1240,
      distanceTraveled: 580,
      fuelEfficiency: 2.90,
      observations: "Rota SP-RJ",
      createdAt: daysAgo(25),
    },
  })
  ...
  const req3 = await prisma.fuelingRequest.create({
    data: {
      vehicleId: scania.id,
      driverId: joao.id,
      contractFuelId: dieselComumGraal.id,
      createdById: admin.id,
      liters: "250",
      fuelType: "DIESEL_COMUM",
      odometer: 209500,
  ...
  await prisma.fueling.create({
    data: {
      ...
      pricePerLiter: 5.95,
      totalAmount: 1487.50,
      distanceTraveled: 780,
      fuelEfficiency: 3.12,
      observations: "Pista dupla",
      createdAt: daysAgo(20),
    },
  })
  ...
  const req4 = await prisma.fuelingRequest.create({
    data: {
      vehicleId: strada.id,
      driverId: mariana.id,
      contractFuelId: etanolIpiranga.id,
      createdById: admin.id,
      liters: "45",
      fuelType: "ETANOL",
      odometer: 43500,
  ...
  const req5 = await prisma.fuelingRequest.create({
    data: {
      vehicleId: strada.id,
      driverId: ana.id,
      contractFuelId: gasolinaComumIpiranga.id,
      createdById: admin.id,
      liters: "48",
      fuelType: "GASOLINA_COMUM",
      odometer: 44100,
  ...
  await prisma.fueling.create({
    data: {
      ...
      fuelEfficiency: 11.45,
      observations: "Rota rodoviária",
      createdAt: daysAgo(8),
    },
  })
  ...
  const req6 = await prisma.fuelingRequest.create({
    data: {
      vehicleId: gol.id,
      driverId: sandro.id,
      contractFuelId: gasolinaAditivadaIpiranga.id,
      createdById: admin.id,
      liters: "40",
      fuelType: "GASOLINA_ADITIVADA",
      odometer: 81200,
  ...
  await prisma.fueling.create({
    data: {
      ...
      fuelEfficiency: 13.00,
      observations: "Visitas técnicas",
      createdAt: daysAgo(12),
    },
  })
  ...
  await prisma.fueling.create({
    data: {
      ...
      observations: "Uso administrativo",
      createdAt: daysAgo(4),
    },
  })
