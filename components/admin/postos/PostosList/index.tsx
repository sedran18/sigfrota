...
import PostoCard, { type PostoData } from "./PostoCard"
...
const PostosList = ({ items }: PostosListProps) => {
  if (!items || items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center text-center p-12 bg-slate-50 border border-slate-200 rounded-none">
